...
public void TC_01() throws IOException
{
	...
	test.log(Status.INFO,MarkupHelper.createLabel("Validate that the Pet service details are successfully deleted  Pet details when valid status passed in URL", ExtentColor.PURPLE));
