...
public class PetPUT extends Reporting {
	...
	public void TC_01() throws IOException
	{
		...
		test.log(Status.INFO,MarkupHelper.createLabel("Validate that the Pet service is successfully updated existing Pet when valid values are passed for all attributes in JSON Request.", ExtentColor.PURPLE));
	...
	public void TC_04() throws IOException
	{
		...
		test.log(Status.INFO,MarkupHelper.createLabel("Validate that the ERROR message is retrieved as response when special character value for ID attribute is passed in JSON Request.", ExtentColor.PURPLE));
